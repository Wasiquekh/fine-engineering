          ...
          <div className="relative overflow-x-auto sm:rounded-lg">
            {selectedJo ? (
              <>
                ...
                <h2 className="text-xl font-bold mb-4">Details for JO:</h2>
                        ...
                        <>
                          <tr key={jo} className="border border-tableBorder bg-white hover:bg-primary-100">
                            ...
                            <td className="px-2 py-2 border border-tableBorder">
                              <div className="flex items-center gap-2">
                                <button onClick={(e) => { e.stopPropagation(); handleJobBackToQC(items); }} className="px-3 py-1 bg-yellow-500 text-white rounded hover:bg-yellow-600 text-sm">QC</button>
                                ...
                                <button onClick={(e) => { e.stopPropagation(); handleJobRejected(items); }} className="px-3 py-1 bg-green-500 text-white rounded hover:bg-green-600 text-sm">Reject</button>
                              </div>
                            </td>
                          </tr>
              ...
              <>
                <h2 className="text-xl font-bold mb-4">Not OK Jobs</h2>
                <table className="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                  <thead className="text-xs text-[#999999]">
                    <tr className="border border-tableBorder">
                      <th scope="col" className="p-3 border border-tableBorder">JO No</th>
