...
export default function VendorIncomingPage() {
  ...
  const getJobNoForIdentifier = (identifier: string) => {
    ...
    const jobType = firstItem?.job_type || firstItem?.job?.job_type;
                ...
                <table className="w-full text-sm text-left text-gray-500">
                  <thead className="text-xs text-[#999999]">
                    <tr className="border bg-gray-50">
                      ...
                      <th className="p-3 border">Job Category</th>
                      <th className="p-3 border">Client Name</th>
                      <th className="p-3 border">Drawing Rec. Date</th>
                      <th className="p-3 border">Description</th>
                      <th className="p-3 border">Material Type</th>
                      <th className="p-3 border text-center">Quantity</th>
                      <th className="p-3 border">Bar</th>
                  ...
                  <tbody>
                    {loading ? (
                      ...
                      <tr><td colSpan={10} className="text-center p-4">No vendor incoming assignments found</td></tr>
                    ) : (
