...
export default function ReviewVendorPage() {
  ...
  // ✅ ACTIONS: only qc, machine, welding, vendor
      ...
      <div className="w-full md:w-[83%] bg-[#F5F7FA] min-h-[500px] rounded p-4 mt-0 relative">
        ...
        <div className="rounded-3xl shadow-lastTransaction bg-white px-1 py-6 md:p-6 relative">
          <div className="flex items-center justify-between mb-4 px-2">
            <div>
              <h1 className="text-xl font-semibold text-firstBlack">Review • Vendor</h1>
          ...
          <div className="relative overflow-x-auto sm:rounded-lg">
                ...
                {data.length === 0 ? (
                  ...
                  data.map((item: any) => (
                    <tr key={item.id} className="border border-tableBorder bg-white hover:bg-primary-100">
                      ...
                      <td className="px-2 py-2 border border-tableBorder">
                        <p className="text-[#232323] text-base">{item.vendor_name || "-"}</p>
                      </td>
                      <td className="px-2 py-2 border border-tableBorder">
            ...
            <div className="text-xs text-gray-500 mt-3 px-2">
              Note: Review/Vendor shows only items coming from QC Vendor Incoming.
            </div>
          </div>
        </div>
      </div>
