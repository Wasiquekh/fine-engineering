...
export default function ReviewPage() {
  ...
  const fetchData = async () => {
    try {
      const response = await axiosProvider.get(`/fineengg_erp/assign-to-worker?job_type=${filterParam}`);
  ...
  const handleQc = async (id: string) => {
    ...
    if (result.isConfirmed) {
      try {
        await axiosProvider.post(`/fineengg_erp/assign-to-worker/${id}/ready-for-qc`, {});
  ...
  const handleReject = async (id: string) => {
    ...
    if (result.isConfirmed) {
      try {
        await axiosProvider.post(`/fineengg_erp/assign-to-worker/${id}/reject`, {});
