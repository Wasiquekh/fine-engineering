      ...
      <div className=" w-full flex justify-between  items-center gap-7 md:mb-14">
        ...
        <div className=" hidden md:w-auto md:flex md:justify-end md:items-center md:gap-7 w-auto z-10">
          <input
            ...
            className=" bg-white w-64 h-[50px] rounded-[4px] px-6 border border-[#E7E7E7] hover:shadow-hoverInputShadow focus-border-primary  placeholder-[#8BA3CB] text-sm leading-normal"
          />
