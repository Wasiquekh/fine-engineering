              ...
              {isMaterialApprovedOpen && (
                <div className="pl-4 flex flex-col gap-1">
                  ...
                  {isMaterialApprovedAmarOpen && (
                    <div className="pl-4 flex flex-col gap-1">
                      <Link href="/section_inventory/inventory_material_approve?filter=JOB_SERVICE&client=Amar%20Equipment&assign_to=Usmaan&assign_to=Riyaaz&assign_to=Ramzan" onClick={(e) => e.stopPropagation()}>
                      ...
                      <Link href="/section_inventory/inventory_material_approve?filter=TSO_SERVICE&client=Amar%20Equipment&assign_to=Usmaan&assign_to=Riyaaz&assign_to=Ramzan" onClick={(e) => e.stopPropagation()}>
                      ...
                      <Link href="/section_inventory/inventory_material_approve?filter=KANBAN&client=Amar%20Equipment&assign_to=Usmaan&assign_to=Riyaaz&assign_to=Ramzan" onClick={(e) => e.stopPropagation()}>
                      ...
                      <Link href="/section_inventory/inventory_material_approve?client=Amar%20Equipment&assign_to_not=Usmaan&assign_to_not=Riyaaz&assign_to_not=Ramzan" onClick={(e) => e.stopPropagation()}>
                  ...
                  {isMaterialApprovedAmarBioOpen && (
                    <div className="pl-4 flex flex-col gap-1">
                      <Link href="/section_inventory/inventory_material_approve?filter=JOB_SERVICE&client=Amar%20Biosystem&assign_to=Usmaan&assign_to=Riyaaz&assign_to=Ramzan" onClick={(e) => e.stopPropagation()}>
                      ...
                      <Link href="/section_inventory/inventory_material_approve?filter=TSO_SERVICE&client=Amar%20Biosystem&assign_to=Usmaan&assign_to=Riyaaz&assign_to=Ramzan" onClick={(e) => e.stopPropagation()}>
                      ...
                      <Link href="/section_inventory/inventory_material_approve?filter=KANBAN&client=Amar%20Biosystem&assign_to=Usmaan&assign_to=Riyaaz&assign_to=Ramzan" onClick={(e) => e.stopPropagation()}>
                      ...
                      <Link href="/section_inventory/inventory_material_approve?client=Amar%20Biosystem&assign_to_not=Usmaan&assign_to_not=Riyaaz&assign_to_not=Ramzan" onClick={(e) => e.stopPropagation()}>
          ...
          <>
            ...
            {isProductionDropdownOpen && (
              <div className="pl-4 mb-4 flex flex-col gap-1">
                ...
                {hasProduction3View && <Production23UserMenu label="Production 3" assignTo="Ramzan" pathname={pathname} client={client} filter={filter} currentAssignTo={assignTo} itemCls={itemCls} iconCls={iconCls} textCls={textCls} permissions={permissions} prodNumber="production3" />}
              </div>
            )}
          </>
        )}
